" vim:fdm=marker
" Vim Color File
" Name:       custom_onedark.vim
" Maintainer: https://github.com/joshdick/custom_onedark.vim/
" License:    The MIT License (MIT)
" Based On:   https://github.com/MaxSt/FlatColor/

" Companion statusline plugin and terminal themes are included with custom_onedark.vim:
"  * https://github.com/joshdick/custom_onedark.vim#lightlinevim-colorscheme
"  * https://github.com/joshdick/custom_onedark.vim#vim-airline-theme
"  * https://github.com/joshdick/custom_onedark.vim/tree/main/term
...
" < https://github.com/joshdick/custom_onedark.vim/blob/main/README.md >
" for more information.)
if !exists("g:custom_onedark_termcolors")
  let g:custom_onedark_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:custom_onedark_terminal_italics")
  let g:custom_onedark_terminal_italics = 0
endif

" This function is based on one from FlatColor: https://github.com/MaxSt/FlatColor/
" Which in turn was based on one found in hemisu: https://github.com/noahfrederick/vim-hemisu/
let s:group_colors = {} " Cache of default highlight group settings, for later reference via `custom_onedark#extend_highlight`
function! s:h(group, style, ...)
  if (a:0 > 0) " Will be true if we got here from custom_onedark#extend_highlight
  ...
  if g:custom_onedark_terminal_italics == 0
  ...
  if g:custom_onedark_termcolors == 16
...
function! custom_onedark#set_highlight(group, style)
  call s:h(a:group, a:style)
endfunction

function! custom_onedark#extend_highlight(group, style)
...
let s:colors = custom_onedark#GetColors()
...
if get(g:, 'custom_onedark_hide_endofbuffer', 0)
